...
public class TestNGAnnotationsExample3 {
	
	//this for report will generate base on group(index.html)
	...
	@Test(priority = 1, groups = "test case")
	public void getURL() {
		System.out.println(driver.getCurrentUrl());
		
	}
	@Test(priority = 2, groups = "test case")
	public void getTitleofPage() {
		
		
		System.out.println(driver.getTitle());
	}
	@Test(priority = 3, groups = "test case")
	public void searchButton() {
		Boolean b1=driver.findElement(By.xpath("//*[@value='Google Search']")).isDisplayed();
	System.out.println(b1);
	}
	
	@Test(priority = 4, groups = "test case")
